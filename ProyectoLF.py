...
#Defino los estados para las transiciones
    ...
    def Estado2():
        ...
        if cont < tam:
            if re.findall('[a-h]|[0-9]', cadena[cont]):
                contador()
                Estado3()
            elif re.findall('(autopista|au|avenida|av|ak|bis|bulevar|bl|carrera|calle|cl|kr|carretera|ct|circular|cq|avenida|av|circunvalar|cc|cv|paseo|ps|via|vi|vereda|vda|vd|kilometro|km|peatonal|pt|vt|transversal|variante|tc|tv|diagonal|troncal|dg|pasaje|pj|cll|krr|transversal)', cadena[cont]):
                contador()
                Estado01()
            else:
    ...
    def Estado01():
        ...
        print("----------------------Estado 01")
        if cont < tam:
            if re.findall('(autopista|au|avenida|av|ak|bis|bulevar|bl|carrera|calle|cl|kr|carretera|ct|circular|cq|avenida|av|circunvalar|cc|cv|paseo|ps|via|vi|vereda|vda|vd|kilometro|km|peatonal|pt|vt|transversal|variante|tc|tv|diagonal|troncal|dg|pasaje|pj|cll|krr|transversal)', cadena[cont]):
                contador()
                Estado2()
